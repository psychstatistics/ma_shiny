    ...
    switch(input$outcome,
         "All" = datasetInput_compgroup() %.% group_by(studyid, comptype) %.% 
                                          summarise(txtype = "All", meastype = "All", 
                                                    d = mean(d), v = mean(v)),
         "Recidivism; getting arrested" = subset(datasetInput_compgroup(), meastype == "Recidivism; getting arrested"),
         "Criminal Deliquency" = subset(datasetInput_compgroup(), meastype == "Criminal Deliquency"),
         "Substance Use" = subset(datasetInput_compgroup(), meastype == "Substance Use"),
         "Internalizing Behaviors" = subset(datasetInput_compgroup(), meastype == "Internalizing Behaviors"),
         "Externalizing Behaviors" = subset(datasetInput_compgroup(), meastype == "Externalizing Behaviors"), 
         "Family Measures" = subset(datasetInput_compgroup(), meastype == "Family Measures"),
         "School Measures" = subset(datasetInput_compgroup(), meastype == "School Measures"),
